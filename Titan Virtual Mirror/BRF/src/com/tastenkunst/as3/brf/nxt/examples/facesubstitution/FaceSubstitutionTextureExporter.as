package com.tastenkunst.as3.brf.nxt.examples.facesubstitution {
	 ...
	 */
	public class FaceSubstitutionTextureExporter extends FaceSubstitutionViewer {
		 ...
		 */
		public function FaceSubstitutionTextureExporter() {
		...
		public function generateTextureAndUVData() : void {
			...
			_textureBounds = faceShape.bounds.clone();
			...
			_uvData = faceShape.faceShapeVertices.concat();
		...
		public function createButton(label : String, x : int, y : int, f : Function) : Button {
