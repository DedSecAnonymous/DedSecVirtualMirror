package com.tastenkunst.as3.brf.nxt.examples.hires {
	import com.tastenkunst.as3.brf.nxt.examples.ExamplePointTracking;
	 ...
	 */
	public class ExamplePointTracking1280x720 extends ExamplePointTracking {
		
		public function ExamplePointTracking1280x720() {
			...
			// All other methods, params etc will be set in and taken from ExamplePointTracking.
