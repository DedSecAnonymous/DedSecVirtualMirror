package com.tastenkunst.as3.brf.nxt.examples.hires {
	import com.tastenkunst.as3.brf.nxt.examples.ExampleFaceDetection;
	 ...
	 */
	public class ExampleFaceDetection1280x720 extends ExampleFaceDetection {
		
		public function ExampleFaceDetection1280x720() {
			...
			// All other methods, params etc will be set in and taken from ExampleFaceDetection.
