package com.tastenkunst.as3.brf.nxt.examples.away3d {
	import com.tastenkunst.as3.brf.nxt.BRFState;
	import com.tastenkunst.as3.brf.nxt.containers.Away3D_v4_1;
	...
	/**
	 * This is a basic Away3D example with 2 3D models of glasses
	 ...
	 * 
	 * The Away3D_v4_1 container uses the same rectangles/resolutions
	 ...
	 */
	public class ExampleAway3D extends ExampleCandideTracking {
		
		// the occlusion head model, that hides the bows of the glasses
		public var _occlusionModel : String = "media/awd/occlusion.awd";
		// first example glasses model
		public var _model1 : String = "media/awd/nooka.awd";
		// second example glasses model
		public var _model2 : String = "media/awd/glasses.awd";
		// current model
		public var _currentModel : String;
		// 3D scene handler
		public var _container3D : Away3D_v4_1;
		
		// size and position of 3d viewport
		public var _viewport : Rectangle;
		
		// texture for webcam image as 3d planeaway
		public var _screenBmd : BitmapData;

		public function ExampleAway3D() {
			//
			// 480p version:
			//
...
//			);
		 ...
		 * and init all necessary stuff for Away3D.
		 */
