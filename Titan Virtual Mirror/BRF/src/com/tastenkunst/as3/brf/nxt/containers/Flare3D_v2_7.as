package com.tastenkunst.as3.brf.nxt.containers {
	 ...
	 */
	public class Flare3D_v2_7 extends Sprite {
		...
		public function init(viewport : Rectangle, cameraResolution : Rectangle, 
			...
			_scene3D.lights.techniqueName = LightFilter.PER_VERTEX;
			_scene3D.lights.defaultLight.color.setTo(0.25, 0.25, 0.25);
			
			_light3D = new Light3D("scene_light", Light3D.POINT);
			_light3D.setPosition( 150, 150, _modelFactor * 0.5);
			_light3D.infinite = true;
			_light3D.color.setTo(255 / 255, 253 / 255, 244 / 255);
			_light3D.multiplier = 1.0;
			_scene3D.addChild(_light3D);
