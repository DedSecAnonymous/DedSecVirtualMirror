package com.tastenkunst.as3.brf.nxt.examples {
...
//			_screenRect			= screenRect		|| new Rectangle(   0,   0, 1280, 720),	// Shown video screen rectangle
		 ...
		 */
		public function onAddedToStage(event : Event = null) : void {trace("MOEP");
