...
:: Android packaging
set AND_CERT_NAME="Titan Virtual Mirror"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TitanVirtualMirror.p12
...
set IOS_PROVISION=cert\TitanVirtualMirror.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=TitanVirtualMirror
